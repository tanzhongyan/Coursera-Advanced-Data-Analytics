...
- **COURSE CONCLUSION**: [Activity_Course 3 TikTok project lab](https://github.com/tanzhongyan/Coursera-Advanced-Data-Analytics/blob/606b26bdd07747ccd3fd9bed68a1d57bf7c800c9/Go%20Beyond%20the%20Numbers%3A%20Translate%20Data%20into%20Insights/Activity_Course%203%20TikTok%20project%20lab.ipynb)
...
- [Activity: Validate and Clean Your Data](./Activity_Validate_and_clean_your_data.ipynb)

### The Power of Statistics: [Certificate](https://coursera.org/share/107827b0e43be6b23e2b470b5c649e6c)
- **COURSE CONCLUSION**: [Activity_Course 4 TikTok project lab](Activity_Course 4 TikTok project lab.ipynb)
- [Activity: Explore Confidence Intervals](./Activity_Explore_confidence_intervals.ipynb)
- [Activity: Explore Descriptive Statistics](./Activity_Explore_descriptive_statistics.ipynb)
- [Activity: Explore Hypothesis Testing](./Activity_Explore_hypothesis_testing.ipynb)
- [Activity: Explore Probability Distributions](./Activity_Explore_probability_distributions.ipynb)
- [Activity: Explore Sampling](./Activity_Explore_sampling.ipynb)

### Regression Analysis: [Certificate](https://coursera.org/share/81960a967d0946e89152d4cfd80dfa38)
- **COURSE CONCLUSION**: [Activity_Course 5 TikTok project lab](Activity_Course 5 TikTok project lab.ipynb)
- [Activity: Evaluate Simple Linear Regression](./Activity_Evaluate_simple_linear_regression.ipynb)
- [Activity: Hypothesis Testing with Python](./Activity_Hypothesis_testing_with_Python.ipynb)
- [Activity: Perform Logistic Regression](./Activity_Perform_logistic_regression.ipynb)
- [Activity: Perform Multiple Linear Regression](./Activity_Perform_multiple_linear_regression.ipynb)
- [Activity: Run Simple Linear Regression](./Activity_Run_simple_linear_regression.ipynb)

### Machine Learning Techniques: [Certificate](https://coursera.org/share/7e4f62c9e56fc9be9771885226a05d64)
- **COURSE CONCLUSION**: [Activity_Course 6 TikTok project lab](Activity_Course 6 TikTok project lab)
- [Activity: Build a Naive Bayes Model](./Activity_Build_a_Naive_Bayes_model)
- [Activity: Build a K-means Model](./Activity_Build_a_K_means_model)
- [Activity: Build a Decision Tree](./Activity_Build_a_decision_tree)
- [Activity: Build a Random Forest Model](./Activity_Build_a_random_forest_model)
- [Activity: Build an XGBoost Model](./Activity_Build_an_XGBoost_model)
